...
import com.softlink.finance.widget.FinancialRequirement;
...
public class Financial implements EntryPoint {
	...
	private FinancialRequirement financialRequirement = new FinancialRequirement(toolbarpanel);
	...
	public void onModuleLoad() {
		...
		userservices.isUserLoggedIn(new AsyncCallback<Boolean>() {
			...
			public void onSuccess(Boolean result) {
				if(result==true){
					lblNewLabel.setText("Welcome To Financial, view About to see what new?");
		...
		financialRequirement.setListener(new FinancialRequirement.Listener() {
			@Override
